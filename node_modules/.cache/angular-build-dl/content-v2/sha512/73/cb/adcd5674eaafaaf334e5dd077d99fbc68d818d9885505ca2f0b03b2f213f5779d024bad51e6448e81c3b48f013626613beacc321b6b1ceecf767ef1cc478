...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(WIService) {
        ...
        value: function getAll() {
          ...
          this.WIService.getAllWi().subscribe(function (res) {
            ...
            for (var i = 0; i < res.message.length; i++) {
              ...
              _this.workItem.push(new _wokitem_workitem__WEBPACK_IMPORTED_MODULE_2__["Workitem"](loc.wi, loc.storyPoint, loc.owner, loc.description, loc.state));
            }
          }, function (err) {
            return console.log(err);
          });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"]],
      providers: [],
  ...
  function srcAppWokitemWorkitemTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function Workitem(wi, storyPoint, owner, description, state) {
